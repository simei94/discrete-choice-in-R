...
##################################### reassamble heating system sample from chapter 6 #####################################
...
# remove alternative heating systems 1 by 1 to inspect substitutional patterns
...
# convert vector of logit probabilities to a matrix 
...
#  calc different adoption rates = means of probabilities for each alternative 
...
###################### nested logit model with 2 nests "room" and "central" #############################
...
# sanity check = sum of probabilities for each decision-maker = 1
...
######################### direct-point and cross-elasticities for nested logit model #############################
...
#################### exercises #############################################################
# 1. Restate the blue bus-red bus situation as a nested logit model.
# What are the marginal and conditional probabilities of this model?
...
# Use a single coefﬁcient for the inclusive variables (i.e., set un.nest.el = TRUE). Are the results reasonable? Discuss.